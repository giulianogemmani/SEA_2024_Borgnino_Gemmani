...
#=========================================================================
    ...
    def refresh_pf(self):
        '''
        function closing and reopening PF
        '''
        self.app.Hide()
        self.app.Show()
        self.app.Rebuild(2)
...
#=========================================================================
    ...
    def get_element_by_name(self, element_name):
        '''
        function getting the PF element having the given name
        '''
        try:
...
#                                                 in research_criteria.items()])]                
    ...
    def get_content(self, pf_object, search_string = '*.*'):
        '''
        ...
        '''
        try:
            return pf_object.GetContents(search_string)
        except Exception as e:
...
#             self.print(traceback.format_exc())
    ...
    def get_diagram_pages(self, diagram_name):
        ...
        try:           
            ...
            # get VI pagea
            return graphic_board.GetContents(diagram_name + '*.SetVipage')
        except Exception as e:
