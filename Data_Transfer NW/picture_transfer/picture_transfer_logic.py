...
################################################################################
    ...
    def run_Simulink_simulation(self, source_file_full_name):
        ...
        '"C:/Users/borgn/OneDrive/Desktop/progetto software/SEA_2024_Borgnino_Gemmani/progetto_software_main_240911'
        ...
        command = ["C:\\Windows\\SysWOW64\\cmd.exe", "/K"]
        
        # Run the command
        # python_311 = subprocess.Popen(command, stdin=subprocess.PIPE, shell=True)
        # python_311.stdin.write('dir\n'.encode())
        # python_311.stdin.flush()
        
        
        # python_311.stdin.write('cd C:\\Users\\borgn\\eclipse-workspace\\Scripts\n'.encode())
        # python_311.stdin.flush()
        ...
        # python_311.stdin.write('python -m venv env_P311\n'.encode())
        # python_311.stdin.flush()
        
        #python_311.stdin.write('python\n'.encode())
        #python_311.stdin.flush()
        
        command = []
        python_311 = subprocess.Popen("activate.bat", cwd = "C:\\Users\\borgn\\OneDrive\\Desktop\\progetto_software\\SEA_2024_Borgnino_Gemmani\\Data_Transfer", stdin = subprocess.PIPE, shell = True)
